...
def connexion(driver):
    ...
    stay_connected = driver.find_element(By.XPATH,"//*[@id='remember-login']").click()
    ip_restrain =driver.find_element(By.XPATH,"//*[@id='secure-session']").click()
    connexion_click = driver.find_element(By.XPATH,"//*[@id='login-form']/fieldset/input[3]").click()
    print(driver.current_url)
